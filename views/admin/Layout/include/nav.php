                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="<?php echo APP_ASSETS ?>images/user/avatar-1.jpg"
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="<?php echo APP_ASSETS ?>images/user/avatar-2.jpg"
                                         alt="Generic placeholder image">
                                    <div class="media-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="<?php echo APP_ASSETS ?>images/user/avatar-3.jpg"
                                         alt="Generic placeholder image">
                                    <div class="media-body">
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="<?php echo APP_ASSETS ?>images/user/avatar-1.jpg" class="img-radius"
                                 alt="User-Profile-Image">
                            <span><?php echo $Auth->AuthName(); ?></span>
                            <a href="<?php echo DASHBOARD . '/logout'; ?>" class="dud-logout" title="Logout">
