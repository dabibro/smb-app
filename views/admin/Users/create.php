                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" id="first_name"
                                                   ...
                                                   class="form-control" value="<?php echo @$edit->first_name; ?>"
                                                   required>
                                            <div class="invalid-feedback">* This is a required field.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="employment_details[dateOfBirth]" id="dateOfBirth"
                                                   class="form-control"
                                                   value="<?php echo @$employment_details->dateOfBirth; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="employment_details[maritalStatus]" id="maritalStatus"
                                                    class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="employment_details[state]" id="state" class="form-control"
                                                    onchange="states_local(this.value,'#lga')">
                                                <option value="">-- Select --</option>
                                                <?php DataHandlers::DropDownList(DataHandlers::StatesList(), 'state', 'state', @$employment_details->state) ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="employment_details[lga]" id="lga" class="form-control">
                                                <option value="">-- Select --</option>
                                                <?php
                                                if (!empty($employment_details->lga)) {
                                                    $states = DataHandlers::StatesList();
                                                    foreach ($states as $list) {
                                                        if ($list['state'] === @$employment_details->state) {
                                                            echo '<option value="">-- Select --</option>';
                                                            foreach ($list['lgas'] as $lgas) {
                                                                echo DataHandlers::DropDownOptions($lgas, $lgas, $employment_details->lga);
                                                            }
                                                        }
                                                    }
                                                }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="employment_details[department]" id="department"
                                                    class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="employment_details[unit]" id="unit"
                                                   class="form-control"
                                                   value="<?php echo @$employment_details->unit; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="employment_details[designation]" id="designation"
                                                   placeholder="Designation"
                                                   class="form-control"
                                                   value="<?php echo @$employment_details->designation; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="Date" name="employment_details[dateOfEmployment]"
                                                   id="dateOfEmployment"
                                                   class="form-control"
                                                   value="<?php echo @$employment_details->dateOfEmployment; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="employment_details[basicSalary]" id="basicSalary"
                                                   class="form-control"
                                                   value="<?php echo @$employment_details->basicSalary; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="next_of_kin[FullName]" id="nokFullName"
                                                   placeholder="Full Name"
                                                   class="form-control" value="<?php echo @$next_of_kin->FullName; ?>"
                                                   required>
                                            <div class="invalid-feedback">* This is a required field.</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="next_of_kin[PhoneNumber]" id="nokPhoneNumber"
                                                   placeholder="Phone Number"
                                                   class="form-control"
                                                   value="<?php echo @$next_of_kin->PhoneNumber; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="next_of_kin[EmailAddress]" id="nokEmailAddress"
                                                   placeholder="Email Address"
                                                   class="form-control"
                                                   value="<?php echo @$next_of_kin->EmailAddress; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="next_of_kin[Address]" class="form-control" id="nokAddress"
                                                      rows="3"
                                                      placeholder="Contact Address"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="guarantor[FullName]" id="guarantorFullName"
                                                   placeholder="Full Name"
                                                   class="form-control" value="<?php echo @$guarantor->FullName; ?>"
                                                   required>
                                            <div class="invalid-feedback">* This is a required field.</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="guarantor[PhoneNumber]" id="guarantorPhoneNumber"
                                                   placeholder="Phone Number"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="guarantor[EmailAddress]"
                                                   id="guarantorEmailAddress" placeholder="Email Address"
                                                   class="form-control"
                                                   value="<?php echo @$guarantor->EmailAddress; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="guarantor[Address]" class="form-control"
                                                      id="guarantorAddress" rows="3"
                                                      placeholder="Contact Address"
                                    ...
                                    <div class="form-group mb-0 pt-lg-4">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input"
                                                   name="isSoftwareUser" <?php echo @$edit->isSoftwareUser; ?>
                                ...
                                <div id="accountInformation">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="username" id="username" placeholder="Username"
                                                       class="form-control" value="<?php echo @$edit->username; ?>"
                                                       required>
                                                <div class="invalid-feedback">* This is a required field.</div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="" class="small w-100 text-left">Default password:
                                                12345678</label>
                                            <?php if (empty($edit->id)) { ?>
                                                <input type="hidden" name="password" value="12345678">
                                            <?php } ?>
                                            <button class="btn-sm btn mr-0 " type="button"><i
                                                        class="feather icon-lock"></i> Reset
                                                password
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <?php if (!empty($edit->id)) { ?>
                                        ...
                                        <a class="btn btn-danger" href="javascript:;"
                                           onclick="location.replace('<?php echo $path; ?>')"><i
