...
(function ($) {
    ...
    $.fn.validate = function (options) {
        ...
        return this.on('submit', function (e) {
            ...
            var data = {};
            $('input,textarea,select', this).filter(":visible,[type='hidden'],[type='date']").each(function () {
                var i = $(this);
    ...
    $.fn.bootstrap3Validate = function (success, data) {
        return this.validate({
            'init': function () {
                $('.is-invalid', this).removeClass('is-invalid').find('input,select,textarea').tooltip('destroy');
                $('.alert').hide();
            ...
            'fail': function (e, invalids) {
                ...
                $(invalids).addClass('is-invalid').closest('.form-group').find('input,select,textarea').each(function (i) {
                    var target = $(this);
