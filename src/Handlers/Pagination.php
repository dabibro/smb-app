...
class Pagination
{
...

    {
        ...
        if ($this->num_pages > 1) {
            ...
            $this->return = ($this->current_page > 1 And $this->items_total >= 10) ? "<div class='row'><div class='col-lg-auto'><ul class='pagination'><li class='page-item'><a class=\"page-link\" href=\"$this->request_uri?page=$prev_page&ipp=$this->items_per_page$this->querystring\"><i class='fal fa-angle-double-left'></i></a></li> " : "<div class='row'><div class='col-lg-auto '><ul class='pagination'><li class='page-item'><a href=\"javascript:;\" class=\"page-link disabled\" tabindex=\"-1\"><i class='fal fa-angle-double-left'></i></a></li> ";
            ...
            for ($i = 1; $i <= $this->num_pages; $i++) {
                ...
                if ($i == 1 Or $i == $this->num_pages Or in_array($i, $this->range)) {
                    ...
                    $this->return .= ($i == $this->current_page And (@$_GET['page'] != 'All')) ? "<li class='page-item active'><a title=\"Go to page $i of $this->num_pages\" class=\"page-link\" href=\"#\">$i</a></li> " : "<li class='page-item'><a class=\"page-link\" title=\"Go to page $i of $this->num_pages\" href=\"$this->request_uri?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
            ...
            $this->return .= (($this->current_page < $this->num_pages And $this->items_total >= 10) And (@$_GET['page'] != 'All') And $this->current_page > 0) ? "<li class='page-item'><a class=\"page-link\" href=\"$this->request_uri?page=$next_page&ipp=$this->items_per_page$this->querystring\"><i class='fal fa-angle-double-right'></i></a></li>\n" : "<li class='page-item'><a href=\"javascript:;\" class=\"page-link disabled\" href=\"javascript:;\" tabindex=\"-1\"><i class='fal fa-angle-double-right'></i></a></li>\n";
            ...
            for ($i = 1; $i <= $this->num_pages; $i++) {
                ...
                $this->return .= ($i == $this->current_page) ? "<div class='row'><div class='col-lg-auto'><ul class='pagination'><li class='page-item active'><a class=\"page-link\" href=\"#\">$i</a></li> " : "<li class='page-item'><a class=\"page-link\" href=\"$this->request_uri?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
...

    {
        ...
        return "<div class='col-lg-auto ml-auto mb-lg-0 mb-3'><div class='form-row  text-right'> <div class='col-auto'> <div class='input-group bg-transparent'> <div class='input-group-prepend'><span class='input-group-text border-0' style='font-size: .79rem !important;'>Show:</span> </div> <select class=' text-muted form-control ' onchange=\"window.location='$this->request_uri?page=1&ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select> </div> </div>\n";
